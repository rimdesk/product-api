...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/rimdesk/product-api/gen/rimdesk/product/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	ProductServiceName = "rimdesk.product.v1.ProductService"
)
...
const (
	...
	// ListProducts RPC.
	ProductServiceListProductsProcedure = "/rimdesk.product.v1.ProductService/ListProducts"
	// ProductServiceCreateProductProcedure is the fully-qualified name of the ProductService's
	// CreateProduct RPC.
	ProductServiceCreateProductProcedure = "/rimdesk.product.v1.ProductService/CreateProduct"
	// ProductServiceGetProductProcedure is the fully-qualified name of the ProductService's GetProduct
	// RPC.
	ProductServiceGetProductProcedure = "/rimdesk.product.v1.ProductService/GetProduct"
	// ProductServiceUpdateProductProcedure is the fully-qualified name of the ProductService's
	// UpdateProduct RPC.
	ProductServiceUpdateProductProcedure = "/rimdesk.product.v1.ProductService/UpdateProduct"
	// ProductServiceDeleteProductProcedure is the fully-qualified name of the ProductService's
	// DeleteProduct RPC.
	ProductServiceDeleteProductProcedure = "/rimdesk.product.v1.ProductService/DeleteProduct"
)

// ProductServiceClient is a client for the rimdesk.product.v1.ProductService service.
...
// NewProductServiceClient constructs a client for the rimdesk.product.v1.ProductService service. By
...
func NewProductServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProductServiceClient {
	...
	productServiceMethods := v1.File_rimdesk_product_v1_product_proto.Services().ByName("ProductService").Methods()
...
// ListProducts calls rimdesk.product.v1.ProductService.ListProducts.
...
// CreateProduct calls rimdesk.product.v1.ProductService.CreateProduct.
...
// GetProduct calls rimdesk.product.v1.ProductService.GetProduct.
...
// UpdateProduct calls rimdesk.product.v1.ProductService.UpdateProduct.
...
// DeleteProduct calls rimdesk.product.v1.ProductService.DeleteProduct.
...
// ProductServiceHandler is an implementation of the rimdesk.product.v1.ProductService service.
...
func NewProductServiceHandler(svc ProductServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/rimdesk.product.v1.ProductService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedProductServiceHandler) ListProducts(context.Context, *connect.Request[v1.ListProductsRequest]) (*connect.Response[v1.ListProductsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("rimdesk.product.v1.ProductService.ListProducts is not implemented"))
}
...
func (UnimplementedProductServiceHandler) CreateProduct(context.Context, *connect.Request[v1.CreateProductRequest]) (*connect.Response[v1.CreateProductResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("rimdesk.product.v1.ProductService.CreateProduct is not implemented"))
}
...
func (UnimplementedProductServiceHandler) GetProduct(context.Context, *connect.Request[v1.GetProductRequest]) (*connect.Response[v1.GetProductResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("rimdesk.product.v1.ProductService.GetProduct is not implemented"))
}
...
func (UnimplementedProductServiceHandler) UpdateProduct(context.Context, *connect.Request[v1.UpdateProductRequest]) (*connect.Response[v1.UpdateProductResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("rimdesk.product.v1.ProductService.UpdateProduct is not implemented"))
}
...
func (UnimplementedProductServiceHandler) DeleteProduct(context.Context, *connect.Request[v1.DeleteProductRequest]) (*connect.Response[v1.DeleteProductResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("rimdesk.product.v1.ProductService.DeleteProduct is not implemented"))
}
